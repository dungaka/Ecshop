...
public abstract class MessageContentHolder extends MessageEmptyHolder {
    ...
    public void layoutViews(final MessageInfo msg, final int position) {
        ...
        // 设置消息的头像
        if (properties.getLeftIconUrl() != null) {
            Glide.with(rootView).load(properties.getLeftIconUrl()).into(leftUserIcon);
        } else {
            Glide.with(rootView).load(R.drawable.default_user_icon).into(leftUserIcon);
        }
        if (properties.getRightIconUrl() != null) {
            Glide.with(rootView).load(properties.getRightIconUrl()).into(rightUserIcon);
        } else {
            Glide.with(rootView).load(R.drawable.default_user_icon).into(rightUserIcon);
        }
