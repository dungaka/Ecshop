 ...
 * 商品详情页面-选择规格购买弹窗
 */
public class GoodsDetailChooseToBuyPopupWindow extends PopupWindow {
    ...
    public GoodsDetailChooseToBuyPopupWindow(Context context) {
        super(context);
        this.context = (Activity) context;
        View contentView = LayoutInflater.from(context).inflate(R.layout.popup__goods_detail_choose_to_buy, null);
