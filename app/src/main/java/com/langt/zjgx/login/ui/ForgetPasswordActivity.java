...
public class ForgetPasswordActivity extends BaseActivity<RegisterPresenter> implements SimpleBaseView {
        ...
        switch (view.getId()){
            ...
            case R.id.btn_register:
                ...
                if(!RegularUtils.isMobileSimple(moblie)){
                    ...
                    presenter.forgetpwd(moblie,pwd,code);
                }
